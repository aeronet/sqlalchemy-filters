...
class Operator(object):
    ...
    OPERATORS = {
        'isEmpty': lambda f: f.is_(None),
        'is_null': lambda f: f.is_(None),
        'isNotEmpty': lambda f: f.isnot(None),
        ...
        'not': lambda f, a: f != a,
        '>': lambda f, a: f > a,
        'after': lambda f, a: f > a,
        'gt': lambda f, a: f > a,
        '<': lambda f, a: f < a,
        'before': lambda f, a: f < a,
        'lt': lambda f, a: f < a,
        '>=': lambda f, a: f >= a,
        'ge': lambda f, a: f >= a,
        'gte': lambda f, a: f >= a,
        'onOrAfter': lambda f, a: f >= a,
        '<=': lambda f, a: f <= a,
        'le': lambda f, a: f <= a,
        'lte': lambda f, a: f <= a,
        'onOrBefore': lambda f, a: f <= a,
        'like': lambda f, a: f.like(a),
        'ilike': lambda f, a: f.ilike(a),
        'not_ilike': lambda f, a: ~f.ilike(a),
        'isAnyOf': lambda f, a: f.in_(a),
